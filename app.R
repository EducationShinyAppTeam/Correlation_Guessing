      ...
      basePerformPlot +
        geom_point(data = tracking$DT,
                   mapping = aes(
                     ...
                     shape = difficulty),
                   size = 4) +
        scale_color_manual(name = "Difficulty",
                           values = c("1" = boastUtils::psuPalette[2],
                                      "2" = boastUtils::psuPalette[1],
                                      "3" = boastUtils::psuPalette[6]),
                           labels = c("Without Outlier",
                                      "With Outlier",
                                      "Surprise")) +
        scale_shape_manual(name = "Difficulty",
                           values = c("1" = 16,
                                      "2" = 17,
                                      "3" = 15),
                           labels = c("Without Outlier",
